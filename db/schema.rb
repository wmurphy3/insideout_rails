...
ActiveRecord::Schema.define(version: 20180802040059) do
  ...
  create_table "mobile_tokens", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.string "token"
  ...
  create_table "reported_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
